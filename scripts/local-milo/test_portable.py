...
files = ['Core/LLM/LLMTypes.swift','Core/LLM/JSONValue.swift','Core/LLM/LLMRequestTime.swift',
         ...
         'Core/LocalMilo/LocalDownloadPolicy.swift','Core/LocalMilo/LocalMiloError.swift','Core/LocalMilo/LocalPrompt.swift','Core/LocalMilo/LocalBrowserPolicy.swift']
with tempfile.TemporaryDirectory(prefix='milo-tests-') as path:
    ...
    for name in ['LocalMiloTests.swift', 'LocalDownloadPolicyTests.swift']:
