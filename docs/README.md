...
## 第 30 轮 · Milo 连续语音对话（设计待确认）

用户已确认连续语音方向，自动收音与语音回复；具体交互待确认。[交互稿](30-milo-voice-chat/design.html)。[需求](30-milo-voice-chat/requirements.md) · [清单](30-milo-voice-chat/checklist.md)。
